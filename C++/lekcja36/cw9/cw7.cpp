...
string szyfruj(string szyfr, string klucz)
{
...
int main()
{
string klucz=usun("NIKT NIE JEST BEZ WAD");
string do_zakodowania=usun_spacje("GENIUSZ TO TYLKO SPRAWA CIERPLIWOSCI");

cout<<"Klucz ----------------->"<<klucz<<endl<<endl;
cout<<"tekst do zakodowania -->"<<do_zakodowania<<endl;
...
string wynik=szyfruj(do_zakodowania,klucz);
